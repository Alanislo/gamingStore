...
//
//
//            Client julianBrunelli = new Client("JulianBrunelli@outlook.com", passwordEncoder.encode("1234"), 43317950, 1925, "36 e/ 123 y 124", "2216178731");
...
//
//
//            Client maximilianoLedesma = new Client("MaximilianoLedesma@outlook.com",  passwordEncoder.encode("1234"), 21056784, 1925, "36 e/ 123 y 124", "115351456");
//            clientRepository.save(maximilianoLedesma);
//
//            Client alanisLobato = new Client("AlanisLobato@outlook.com", passwordEncoder.encode("1234"), 43417900, 1925, "36 e/ 123 y 124", "2216204142");
//            clientRepository.save(alanisLobato);
//
//            Client darylBaptie = new Client("DarylBaptie@outlook.com",  passwordEncoder.encode("1234"), 35042684, 1925, "36 e/ 123 y 124", "114972353");
