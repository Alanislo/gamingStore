...
public class WellPlayedApplication {
    ...
    public CommandLineRunner initData(ClientRepository clientRepository, ComponentRepository componentRepository, BuyRepository buyRepository, TicketRepository ticketRepository) {
        return args -> {
         ...
         Component microphoneRode1= new Component("Microphone", "Rode", "PodMic USB", "The PodMic USB is an ultra-versatile dynamic microphone ideal for podcasting, streaming, gaming, voice overs, and other speech applications for content creation. It delivers rich, full-bodied sound and features both an XLR and USB output for connecting to an audio interface or mixer like a classic broadcast microphone, or directly to a computer for plug-and-play recording. The digital USB output features RØDE’s ultra-low-noise, high-gain Revolution Preamp™ and powerful APHEX® digital signal processing for capturing studio-quality sound with ease, and a zero-latency headphone output complete with level control, making recording seamless. For even more versatility, the PodMic USB is also fully compatible with iOS and Android mobile devices, offering a high-quality portable podcasting or streaming solution", Arrays.asList("Ultra-low-noise, high-gain Revolution Preamp", "Analog XLR and digital USB-C connectivity", "Fully compatible with Windows and Mac computers, and iOS and Android devices", "Broadcast-quality dynamic microphone"), Arrays.asList("Black"), Arrays.asList("https://i.imgur.com/AwCR6yo.jpg", "https://i.imgur.com/ddk5VoH.jpg", "https://i.imgur.com/rK0EJkM.jpg", "https://i.imgur.com/IFtcvlT.jpg", "https://i.imgur.com/Stm8QZN.jpg"), 199.99, 100);

         Component microphoneRode2= new Component("Microphone", "Rode", "NT-USB", "The NT-USB is a professional USB condenser microphone that delivers exceptional performance for recording vocals and instruments, gaming and livestreaming, podcasting, voice-overs and more. Offering impeccable audio, elegant looks and premium features, all in an easy-to-use form factor, the NT-USB will have you sounding like a pro in seconds", Arrays.asList("Professional USB condenser microphone", "Professional pop filter and tripod included", "High-power headphone output for zero-latency", "On-board monitor level and headphone mix controls"), Arrays.asList("Black"), Arrays.asList("https://edge.rode.com/images/page/349/modules/1225/R%C3%98DE_NT-USB_3_QUARTER_FRONT_1080x1080.png", "https://edge.rode.com/images/page/349/modules/1225/R%C3%98DE_NT-USB_Front_1080x1080.png", "https://edge.rode.com/images/page/349/modules/1225/R%C3%98DE_NT-USB_3_QUARTER_BACK_1080x1080.png", "https://edge.rode.com/images/page/349/modules/1225/R%C3%98DE_NT-USB_3_QUARTER_FRONT_1080x1080.png"), 249.99, 100);
         ...
         componentRepository.save(microphoneRode2);
